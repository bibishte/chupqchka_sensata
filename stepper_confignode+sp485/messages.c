...
const char string_14[] PROGMEM = "RMinSpd=";
const char string_15[] PROGMEM = "RMaxSPD=";
const char string_16[] PROGMEM = "RAcc=";
const char string_17[] PROGMEM = "Stop\r";
const char string_18[] PROGMEM = "Enable\r";
const char string_19[] PROGMEM = "Disable\r";
const char string_20[] PROGMEM = "NOT SET MODE\r";
const char string_21[] PROGMEM = "NOT SET DECAY\r";
const char string_22[] PROGMEM = "Done ";
const char string_23[] PROGMEM = " steps\r";
